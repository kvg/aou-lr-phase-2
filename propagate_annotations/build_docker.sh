#!/usr/bin/env bash
# Build (and optionally push) the propagate-annotations Docker image.
#
# Defaults:
#   image  us-central1-docker.pkg.dev/broad-dsp-lrma/aou-lr/aou-propagate-annotations:0.1.0
#
# Usage:
#   ./build_docker.sh
#   ./build_docker.sh --local
#   ./build_docker.sh --local --push
#   ./build_docker.sh --tag 0.1.1
...
DEFAULT_IMAGE="us-central1-docker.pkg.dev/broad-dsp-lrma/aou-lr/aou-propagate-annotations"
DEFAULT_TAG="0.3.1"
...
usage() {
  cat <<EOF
Build the propagate-annotations image.
