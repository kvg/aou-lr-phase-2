...
```
notebooks/sv_00_prepare_caddsv_annotations.ipynb
notebooks/sv_01_stage_repeat_tracks.ipynb
notebooks/sv_02_stage_sample_ancestry.ipynb
notebooks/sv_03_manuscript_stats.ipynb
...
```bash
cd sv_annotation
./build_docker.sh                 # Cloud Build → aou-sv-annotation:0.1.4
...
2. Build the CADD-SV annotation bundle once on a machine/Workbench with ≥60 GB
   ...
   notebook [`../notebooks/sv_00_prepare_caddsv_annotations.ipynb`](../notebooks/sv_00_prepare_caddsv_annotations.ipynb),
...
3. Stage RepeatMasker / simple-repeat / segdup BEDs with
   [`../notebooks/sv_01_stage_repeat_tracks.ipynb`](../notebooks/sv_01_stage_repeat_tracks.ipynb)
   (`$WORKSPACE_BUCKET/refs/grch38/`).
4. Stage sample ancestry TSVs with
   [`../notebooks/sv_02_stage_sample_ancestry.ipynb`](../notebooks/sv_02_stage_sample_ancestry.ipynb)
